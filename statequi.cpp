#include "statequi.h"
#include "ui_statequi.h"

statequi::statequi(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::statequi)
{
    ui->setupUi(this);
...
void statequi::paintEvent(QPaintEvent *)
{
